...
<html>
    <head>
        <title>Surat Keterangan Penghasilan Orangtua</title>
        <link rel="stylesheet" type="text/css" href="SuratPenghasilan.css">
    ...
    <div class="kanan"><br>
        <div id="background">
        <p> Masukkan Data Surat Penghasilan Orangtua</p>
        <form>
            <input type="text" name="" placeholder="Nama Lengkap"><br>
            <input type="text" name="" placeholder="Jenis Kelamin"><br>
            <input type="text" name="" placeholder="Pekerjaan"><br>
            <input type="text" name="" placeholder="Alamat"><br>
            <input type="text" name="" placeholder="Penghasilan (1 bulan)"><br>
            <input type="text" name="" placeholder="Umur"><br>
            <br>

            <p id="indexx">Adalah orangtua dari</p>
            <input type="text" name="" placeholder="Nama Lengkap"><br>
            <input type="text" name="" placeholder="Jenis Kelamin"><br>
