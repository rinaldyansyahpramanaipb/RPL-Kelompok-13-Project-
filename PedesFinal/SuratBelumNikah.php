...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="SuratBelumNikah.css">
    ...
    <div class="kanan"><br>
        ...
        <form>
            ...
            <input type="text" name="" placeholder="Surat ini dipergunakan untuk..."><br>
        </form>
        <br>
        <button onclick="" class="button">Simpan</button> <!-- forward ke progress pembuatan surat -->
        </div>
    </div>
